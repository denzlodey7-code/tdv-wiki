...
Это showcase-файл. Он покрывает все типы компонентов шаблона и служит регрессионным тестом после изменений.
</Callout>

<Callout type="warning" title="Важно">
При добавлении нового типа контента в шаблон, обязательно добавьте пример в этот файл.
</Callout>
