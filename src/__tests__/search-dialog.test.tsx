    ...
    items: [
      {
        ...
        title: "Introduction",
        order: 1,
        snippet: "Learn the basics of the system",
      },
      {
        slug: "quick-start",
        title: "Quick Start",
        order: 2,
        snippet: "Get up and running in 5 minutes",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        title: "API Reference",
        order: 1,
        snippet: "Complete API documentation with examples",
      },
    ],
  },
];
...
describe("SearchDialog", () => {
  ...
  it("не рендерится когда open=false", () => {
    const { container } = render(
      <SearchDialog {...defaultProps} open={false} />,
    );
